...
object FxApp {
  ...
  def main(args: Array[String]): Unit = {
    val source: Iterator[String] = Source.fromFile("src\\Base De Dados\\carrosDefault.txt").getLines()
    val source2: Iterator[String] = Source.fromFile("src\\Base De Dados\\mecanicosDefault.txt").getLines()
